...
function authorun(arg1, arg2, arg3) {
    var name, view, scope;
    if (typeof arg1 === "string") {
        ...
        name = arg1.name || ("authorun@" + getNextId());
        view = arg1;
        scope = arg2;
    }
...
function when(arg1, arg2, arg3, arg4) {
    ...
    var disposer = authorun(name, function (r) {
...
exports.when = when;
function authorunAsync(arg1, arg2, arg3, arg4) {
    ...
    if (typeof arg1 === "string") {
        ...
        name = arg1.name || ("authorunAsync@" + getNextId());
        func = arg1;
        delay = arg2;
        scope = arg3;
    }
...
exports.authorunAsync = authorunAsync;
...
var messages = {
    ...
    "m004": "authorun expects a function",
    "m005": "Warning: attempted to pass an action to authorun. Actions are untracked and will not trigger on state changes. Use `reaction` or wrap only your state modification code in an action.",
    "m006": "Warning: attempted to pass an action to authorunAsync. Actions are untracked and will not trigger on state changes. Use `reaction` or wrap only your state modification code in an action.",
